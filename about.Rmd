...
1) Create `tropical-repo` organization on github.
...
3) Create a github.io repo for `tropical-repo.github.io`. Initial repo is public. **MUST initialize repo with a README**---this creates a master branch.
4) Cloned the source code repo `git clone https://github.com/tropical-repo/web.git`.
5) `cd web/`
...
* `git submodule add -b main https://github.com/tropical-repo/tropical-repo.github.io.git public`
