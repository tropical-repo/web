...
macrofaunal abundance and diversity, as well as significant increases in
microbial community instability. Using an integrative time-series
approach we identify specific oxygen thresholds that appear to underpin
changes in both macro- and micro- benthic diversity. Through space and
time oxygen stress plays an extreme role in community destabilization.
...
2. When the microbial community is most unstable the benthic macrofauna diversity and abundance is moste reduced (supporting the idea that the increased community dispersal is deleterious). 
